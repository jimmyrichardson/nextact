...
Yellow #ebab00 / 235,171,0
Blue #03aae3 / 3,170,227

"We put the ~HEAT~ in theater" - Next Act
...
<head>
    ...
    <link rel="shortcut icon" href="<?= get_stylesheet_directory_uri(); ?>/assets/img/favicon.png">
    <?php wp_head(); ?>
</head>
<body>
    <nav id="nav">
        ...
        <div id="tickets-cal">
            <a id="tickets" href="/ticket-office/" class="ticket-cta akz-cond">Buy Tickets</a>
            <a id="support" href="/support/" class="akz-cond">Support</a>
        </div>
		<a id="cal" href="/calendar/">
			<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 21.76 21.76">
				<circle cx="10.88" cy="10.88" r="10.38" style="fill:none;stroke:#fff;stroke-miterlimit:10"/>
				<path d="M14.74,7.12V5.77h-.2V7.12H13V5.77h-.19V7.12H11.07V5.77h-.19V7.12H9.14V5.77H9V7.12H7.41V5.77h-.2V7.12H5.86V16h10V7.12Zm1,8.68H6.05v-6H15.7Zm-9.65-6V7.5H7.21v.77h.2V7.5H9v.77h.19V7.5h1.74v.77h.19V7.5h1.74v.77H13V7.5h1.54v.77h.2V7.5h1V9.82Z" style="fill:#fff"/>
				<path d="M8.2,12.57a.62.62,0,1,0,0-1.23.62.62,0,0,0,0,1.23Z" style="fill:#fff"/>
				<path d="M10,12.57a.62.62,0,1,0,0-1.23.62.62,0,0,0,0,1.23Z" style="fill:#fff"/>
				<path d="M11.89,12.57a.62.62,0,0,0,0-1.23.62.62,0,1,0,0,1.23Z" style="fill:#fff"/>
				<path d="M13.73,12.57a.62.62,0,1,0-.61-.62A.61.61,0,0,0,13.73,12.57Z" style="fill:#fff"/>
				<circle cx="8.2" cy="13.8" r="0.61" style="fill:#fff"/>
				<circle cx="10.04" cy="13.8" r="0.61" style="fill:#fff"/>
				<path d="M11.89,14.41a.61.61,0,0,0,.61-.61.61.61,0,0,0-.61-.62.62.62,0,0,0-.62.62A.61.61,0,0,0,11.89,14.41Z" style="fill:#fff"/>
				<path d="M13.73,14.41a.61.61,0,0,0,.61-.61.61.61,0,1,0-1.22,0A.61.61,0,0,0,13.73,14.41Z" style="fill:#fff"/>
			</svg>
		</a>
        <div id="socials">
            <ul>
                <li>
                    <a href="tel:14142787780">
                    </a>
                </li>
                <li>
                    <a href="https://linkedin.com/company/nextacttheater" target="_blank">
                        <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.76 21.76">
                        <circle cx="10.88" cy="10.88" r="10.38" style="fill:none;stroke:rgba(255,255,255,0.6);;stroke-miterlimit:10"/>
                        <path d="M6.15,8.64H8.23v6.68H6.15Zm1-3.32A1.21,1.21,0,1,1,6,6.52a1.2,1.2,0,0,1,1.21-1.2" style="fill:rgba(255,255,255,0.6);"/>
                        <path d="M9.53,8.64h2v.91h0a2.18,2.18,0,0,1,2-1.08c2.1,0,2.49,1.39,2.49,3.19v3.66H13.93V12.07c0-.77,0-1.77-1.08-1.77S11.6,11.14,11.6,12v3.3H9.53Z" style="fill:rgba(255,255,255,0.6);"/>
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="https://facebook.com/nextactMKE" target="_blank">
                        <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.76 21.76">
                        <path d="M15.23,6H6.52A.54.54,0,0,0,6,6.52v8.71a.54.54,0,0,0,.54.54h4.69V12H9.94V10.5h1.27V9.41a1.78,1.78,0,0,1,1.9-1.95,9.72,9.72,0,0,1,1.14.06V8.84h-.78c-.61,0-.73.29-.73.72v.94H14.2L14,12H12.74v3.79h2.49a.54.54,0,0,0,.54-.54V6.52A.54.54,0,0,0,15.23,6Z" style="fill:rgba(255,255,255,0.6);"/>
                         <circle cx="10.88" cy="10.88" r="10.38" style="fill:none;stroke:rgba(255,255,255,0.6);;stroke-miterlimit:10"/>
                        </svg>
                    </a>
                </li>
                <li>
                    <a href="https://instagram.com/nextactMKE" target="_blank">
                        <svg width="25" height="25" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.76 21.76">
                        <circle cx="10.88" cy="10.88" r="10.38" style="fill:none;stroke:rgba(255,255,255,0.6);stroke-miterlimit:1"/>
                        <path d="M10.9,6.4c1.55,0,1.73,0,2.35,0a3.4,3.4,0,0,1,1.08.2,1.74,1.74,0,0,1,.66.44,1.7,1.7,0,0,1,.44.67,3.27,3.27,0,0,1,.2,1.08c0,.61,0,.79,0,2.34s0,1.74,0,2.35a3.27,3.27,0,0,1-.2,1.08,1.78,1.78,0,0,1-.44.67,1.87,1.87,0,0,1-.66.44,3.72,3.72,0,0,1-1.08.2c-.62,0-.8,0-2.35,0s-1.74,0-2.35,0a3.64,3.64,0,0,1-1.08-.2,2,2,0,0,1-.67-.44,1.75,1.75,0,0,1-.43-.67,3,3,0,0,1-.2-1.08c0-.61,0-.79,0-2.35s0-1.73,0-2.34a3,3,0,0,1,.2-1.08,1.68,1.68,0,0,1,.43-.67,1.86,1.86,0,0,1,.67-.44,3.34,3.34,0,0,1,1.08-.2c.61,0,.8,0,2.35,0m0-1.05c-1.58,0-1.78,0-2.4,0a3.91,3.91,0,0,0-1.41.27,2.65,2.65,0,0,0-1,.67,2.82,2.82,0,0,0-.67,1,4.4,4.4,0,0,0-.27,1.41c0,.62,0,.82,0,2.39s0,1.78,0,2.4A4.4,4.4,0,0,0,5.39,15a3,3,0,0,0,1.7,1.7,4.14,4.14,0,0,0,1.41.27c.62,0,.82,0,2.4,0s1.77,0,2.39,0a4.21,4.21,0,0,0,1.42-.27,3,3,0,0,0,1-.67,2.9,2.9,0,0,0,.67-1,4.4,4.4,0,0,0,.27-1.41c0-.62,0-.82,0-2.4s0-1.77,0-2.39a4.4,4.4,0,0,0-.27-1.41,2.82,2.82,0,0,0-.67-1,2.73,2.73,0,0,0-1-.67,4,4,0,0,0-1.42-.27c-.62,0-.81,0-2.39,0Z" style="fill:rgba(255,255,255,0.6);"/>
                        <path d="M10.9,8.18a3,3,0,1,0,3,3A3,3,0,0,0,10.9,8.18Zm0,4.92a1.94,1.94,0,1,1,1.94-1.94A1.94,1.94,0,0,1,10.9,13.1Z" style="fill:rgba(255,255,255,0.6);"/>
                        <circle cx="14" cy="8.06" r="0.7" style="fill:rgba(255,255,255,0.6);"/>
                        </svg>
                    </a>
                </li>
            </ul>
...
<div id="mobile">
	...
	<div id="swipe-1" class="swipe"></div>
	<div id="swipe-2" class="swipe"></div>
